...
import org.tigase.messenger.phone.pro.roster.ContactFilterFragment;
...
public class MainActivity
	...
	private void switchMainFragment(final int id) {
		...
		switch (id) {
			...
			// MES CONTACTS EN FILTRE
			case R.id.nav_my_contact : {
				FragmentManager fragmentManager = getSupportFragmentManager();
				fragmentManager.beginTransaction()
						.replace(R.id.flContent, ContactFilterFragment.newInstance(getServiceConnection()))
						.commit();
