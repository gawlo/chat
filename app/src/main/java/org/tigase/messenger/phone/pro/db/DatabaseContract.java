...
public final class DatabaseContract {
	...
	public class TbNumero
			implements BaseColumns {

		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.mobilemessenger.tbnumero";
		public static final String TABLE_NAME = "tablenumero";
		public static final String TBN_ID = "_id";
		public static final String TBN_NUMERO = "numero";

		public static final String CREATE_TABLE =
				"CREATE TABLE " + TABLE_NAME + " (" + TBN_ID + " INTEGER PRIMARY KEY, " + TBN_NUMERO + " TEXT, " + ");";
