...
public class EditContactActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//numerocontact =mContactXMPPID.getText().toString()+"@xmppsrv.orange-bissau.com";
	...
	private void onAddButtonClick() {
		...
		BareJID jid;
		//mContactXMPPID.setText(mContactXMPPID.getText().toString()+"@xmppsrv.orange-bissau.com");
		try {
			...
			String bjid= mContactXMPPID.getText().toString()+"@xmppsrv.orange-bissau.com";
			//jid = BareJID.bareJIDInstance(mContactXMPPID.getText().toString()+"@xmppsrv.orange-bissau.com");
			jid=BareJID.bareJIDInstance(bjid);
			//jid = BareJID.bareJIDInstance(numerocontact);
		} catch (Exception e) {
			mContactXMPPID.setError(getString(R.string.contact_xmppid_invalid));
			return;
		}
	...
	private static class AddContactTask
		...
		private ApiInterface apiInterface = ApiCLient.getClient_db().create(ApiInterface.class);
